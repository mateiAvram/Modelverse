...
export function NavBar({
  ...
  return (
    <div
      className={`relative top-0 z-10 h-fit w-full shrink-0 border-b-2 bg-white md:sticky ${
        isVisible
          ? 'md:translate-y-0 md:duration-500'
          : 'md:-translate-y-full md:duration-500'
      } ${!extendedMenu ? 'h-32' : 'h-96'}`}
    >
      <div className="flex w-full flex-row flex-wrap items-center-safe px-6 py-4 xl:mx-auto xl:max-w-[1280px] 2xl:max-w-[1600px]">
